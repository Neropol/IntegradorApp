...
dependencies {
    ...
    testImplementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.7.3") //corrutinas test
    ...
    androidTestImplementation("androidx.core:core-testing:1.12.0-rc01")
